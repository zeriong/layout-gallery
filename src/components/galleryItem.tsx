    ...
    return (
        ...
        >
            <section
                ...
                <article className="p-2 text-center sm:p-4 h-2/6 overflow-hidden relative flex flex-col sm:text-start sm:items-start justify-center sm:justify-start items-center">
